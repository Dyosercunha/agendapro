...
function proClient(){const p=window.location.pathname.split("/").filter(Boolean);const first=String(p[0]||"").toLowerCase();return !!slugFromPathname(window.location.pathname)&&!["painel","plataforma","painel-plataforma"].includes(first);}
